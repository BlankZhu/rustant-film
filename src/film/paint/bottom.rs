...
impl Painter for BottomPainter {
    fn paint(
        ...
        add_text(
            ...
            height + (standard_padding as f32 * 0.5) as u32,
            lens_model_text,
            &font_scale,
            &self.font,
            &BLACK,
        ...
        add_text(
            image,
            (standard_padding as f32 * 0.5) as u32,
            height + (standard_padding as f32 * 0.5) as u32 + font_height as u32,
            camera_model_text,
            &font_scale,
            &self.font,
            &GRAY,
        ...
        add_vertical_line(
            image,
            width - standard_padding as u32 - detail_area_max_width as u32,
            height + (standard_padding as f32 * 0.5 + font_height * 0.125) as u32,
